...
/**
 * Created by ANGELZIN on 2017-03-26.  카테고리 8개 커스텀 java
 */
...
public class CustomCategoryButton extends LinearLayout{
    ...
    public CustomCategoryButton(Context context, AttributeSet attrs,int defStyle){
        super(context, attrs);
        initView(); getAttrs(attrs, defStyle);
    }
    ...
    private void initView(){
        ...
        View v = li.inflate(R.layout.custom_category_bt, this, false);
        addView(v);
    ...
    {
        //int bg_resID = typedArray.getResourceId(R.styleable.LoginButton_bg, R.drawable.book);
        //bg.setBackgroundResource(bg_resID);

        int symbol_resID = typedArray.getResourceId(R.styleable.LoginButton_symbol, R.drawable.book);
        symbol.setImageResource(symbol_resID);

        //int textColor = typedArray.getColor(R.styleable.LoginButton_textColor, 0);
        //text.setTextColor(textColor);

        String text_string = typedArray.getString(R.styleable.LoginButton_text_);
